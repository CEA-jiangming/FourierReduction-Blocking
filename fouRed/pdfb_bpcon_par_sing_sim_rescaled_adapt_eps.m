function [xsol, L1_v, L1_vp, L2_v, L2_vp, delta_v, sol_v, snr_v, v1, v2, sol_reweight_v] = pdfb_bpcon_par_sing_sim_rescaled_adapt_eps(y, imsize, epsilont, epsilonts, epsilon, epsilons, A, At, T, W, Psi, Psit, Psiw, Psitw, param)
%
...
%-----------------------%
if ~isfield(param, 'use_adapt_bound_eps') %%##### AR
    param.use_adapt_bound_eps = 0;
end
if ~isfield(param, 'hard_thres')  %%##### AR
    param.hard_thres = 0;
end
%-----------------------%
